...
<div class=""note"">Assembly is not indexed. References to the symbol in the indexed assemblies are shown to the left.</div>
        ...
        private static string documentHtmlPrefixTemplate = @"
        <div className=""cB"">";
        private static string documentTablePrefix = @"<div className=""cz""><table className=""tb"" cellpadding=""0"" cellspacing=""0""><tr>{1}<td valign=""top"" align=""right""><pre id=""ln"">{0}</pre></td><td valign=""top"" align=""left""><pre id=""code"">";
        ...
        {
            var html = documentHtmlPrefixTemplate;
            return html;
        }
        ...
        {
            return string.Format("<a id=\"{0}\" href=\"#{0}\" target=\"_top\">{0}</a><br/>", i);
        }

        public static string GetDocumentSuffix()
        {
            return @"</pre></td></tr></table></div></div>";
        }
...
", projectTitle);
        ...
        {
            writer.WriteLine(@"<div class=""solutionExplorerBody"">
    <div id=""rootFolder"" class=""folderTitle"">");
        }

        public static void WriteSolutionExplorerSuffix(TextWriter writer)
        {
            writer.WriteLine("</div></div></html>");
        }
