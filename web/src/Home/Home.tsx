    ...
    render() {
        return (
            <article>
                ...
                <p>
                    If you'd like to contribute or spot an inaccuracy, this site is on <a href="https://github.com/ronbrogan/OpenBlam.com">Github</a> - pull requests and issues are welcome.
                </p>
                <em>
                    - Ron
                </em>
